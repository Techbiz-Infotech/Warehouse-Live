page 50229 WarehouseSalesInvoice
{
    //ApplicationArea = All;
    ...
    SourceTableView = where("Document Type" = filter(Invoice), Warehouse = filter(true));
    ...
    layout
    {
        area(content)
        {
            ...
            part(SalesLines; WarehouseSalesInvoiceSubform)
            {
                ApplicationArea = Basic, Suite;
    ...
    actions
    {
        ...
        area(processing)
        {
            group(Approval)
            {
                ...
                action("IMS Copy Document")
                {
                    ApplicationArea = all;
                    Image = Copy;
                    Caption = 'Copy Warehouse Proforma Invoice';
                    trigger OnAction()
                    begin
                        IMSCopyDocument();
        ...
        area(Promoted)
        {
            ...
            group(Category_Category6)
            {
                ...
                actionref(CopyDocument_Promoted; "IMS Copy Document")
                {
                }
            }
    ...
    var
        IMSCopyDoc: Report "IMS WH Copy Sales Document";
    begin
