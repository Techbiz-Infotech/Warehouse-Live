page 50222 "WH Proforma Invoice list"
{
    ApplicationArea = Basic, Suite, Assembly;
    Caption = 'Warehouse Proforma Invoices';
    CardPageID = "Warehouse Proforma Invoice";
    ...
    SourceTableView = SORTING("Document Type", "No.") ORDER(Descending) WHERE("Document Type" = CONST(Order), Warehouse = const(true), Closed = const(false));
    UsageCategory = Lists;
