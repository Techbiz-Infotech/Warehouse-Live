...
page 50230 "Warehouse Sales Invoice List"
{
    ...
    CardPageID = "WarehouseSalesInvoice";
    DataCaptionFields = "Sell-to Customer No.";
    Editable = false;
    QueryCategory = 'Warehouse Sales Invoice List';
    RefreshOnActivate = true;
    SourceTableView = where("Document Type" = const(Invoice), Warehouse = const(true), Closed = const(false));
